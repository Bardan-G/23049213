...
export class ChatGateway implements OnGatewayConnection, OnGatewayDisconnect {
    ...
    async handleMessage(
        ...
        // Also notify admins if the receiver is an admin (or a general message to admins)
        // We emit to the 'admins' room
        if (!receiverSocketId) {
            // Optionally you could check if receiver is admin then emit to room
